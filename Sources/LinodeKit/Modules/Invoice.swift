...
extension LinodeKit {
    struct Invoice {
        ...
        static func list(page:Int = 1, pageSize: Int = 100, success:@escaping(PagedResponse<[InvoiceModel]>) -> Void,error:((APIError) -> Void)? = nil) {
        ...
        /// - Parameter error: Error block that returns APIError model
        static func view(_ invoiceId:Int, success:@escaping(InvoiceModel) -> Void,error:((APIError) -> Void)? = nil) {
